    ...
    def render(self, name, value, attrs=None, renderer=None):
        ...
        return format_html('<div class="form-row">{}</div>',
            format_html_join('\n',
                ...
                ((force_str(w), w.choice_value, force_str(self.BUTTON_TYPES[w.choice_value])) for w in renderer)))
    ...
    def render(self, name, value, attrs=None, renderer=None):
        ...
        return format_html('<div class="form-row">{}</div>',
            format_html_join('\n',
                ...
                '</div>',
                ((force_str(w), w.choice_value, force_str(self.BUTTON_SIZES[w.choice_value])) for w in renderer)))
...
class BootstrapButtonPlugin(BootstrapButtonMixin, LinkPluginBase):
    ...
    def get_identifier(cls, obj):
        ...
        if not content:
            try:
                content = force_str(ButtonTypeWidget.BUTTON_TYPES[obj.glossary['button_type']])
            except KeyError:
                content = _("Empty")
